...
export default  function UserMetaCard({ agent }: UserMetaCardProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (res.status) {
        ...
        // setModal({ message: "Failed to submit form." , type: "error" });
              ...
              <div className="mt-1">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  <div className="col-span-2 lg:col-span-1">
                    ...
                    <Input type="text" name="agentname" defaultValue={agent.agentname} {...{ required: true }} />
                  </div>

                  <div className="col-span-2 lg:col-span-1">
                    <Label>Last Name</Label>
                    <Input type="text" name="agentsurname" defaultValue={agent.agentsurname} {...{ required: true }}/>
                  </div>
