...
export default function UserDropdown() {
  ...
  // const [localStorageAgentemailaddress, setLocalStorageAgentemailaddress] = useState("");
  // const [localStorageProfileThumnal, setLocalStorageProfileThumnal] = useState("");
      ...
      >
        <div>
          <span className="block font-medium text-gray-700 text-theme-sm dark:text-gray-400">
            ...
            {/* {localStorageAgentName} {localStorageAgentsurname} */}
          </span>
          <span className="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400">
            {/* randomuser@pimjo.com */}
            {agentEmailaddress}
            {/* {localStorageAgentemailaddress} */}
          </span>
        </div>
        ...
        <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-800">
          <li>
            <DropdownItem
              ...
              tag="a"
              href={`/${route.locale}/admin/profile`}
        ...
        <button
          onClick={() => {
            ...
            localStorage.removeItem("agentsurname");
            localStorage.removeItem("emailaddress");
            localStorage.removeItem("profilethumnal");
