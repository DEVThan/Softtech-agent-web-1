  ...
  return (<>
    <div className="content">
      ...
      <div className="section mt-0 sm:mt-2 md:mt-8">
        <div className='text-center'><label htmlFor="" className='title font-bold'>OUR PRODUCTS</label></div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 mt-2 gap-4">
          ...
          <div className="panel mb-2" >
            <div className="flex flex-col items-center text-center p-5">
              ...
              <div className='mt-2'><label className='title'>SOFTTECH M1</label></div>
              ...
              <div className='mt-2'> 
                <a type="button"  key={locale} href={`/${locale}/product-detail`} className="btn-primary w-auto bg-[#0874B6] text-white px-6 py-2 rounded-3xl mt-2 hover:underline">{common.button.readmore}</a>
              </div>
            </div>
          </div>
          <div className="panel mb-2" >
      ...
      <div className="section">
        <div className='text-center mt-3'><label htmlFor="" className='title font-bold'>ABOUT US</label></div>
          ...
          <div className="basis-2/3 flex">
            <div className="rounded-xl px-6 py-6 ">
              ...
              <div className='text-center'>
                <a type="button"  key={locale} href={`/${locale}/aboutus`} className="btn-primary w-auto bg-[#0874B6] text-white px-6 py-2 rounded-3xl mt-2 hover:underline">{common.button.readmore}</a>
              </div>
            </div>
          </div>
        </div>
